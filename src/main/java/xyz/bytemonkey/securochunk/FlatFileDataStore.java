...
public class FlatFileDataStore extends DataStore {
    ...
    @Override
    synchronized public void loadWorldData(String worldName) throws Exception {
...
//					}
    ...
    @Override
    synchronized public void writeChunkToStorage(Chunk chunk) {
    ...
    synchronized public PlayerData getPlayerDataFromStorage(String playerName) {
