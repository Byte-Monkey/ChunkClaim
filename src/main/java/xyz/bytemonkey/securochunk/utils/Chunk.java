...
public class Chunk {
    ...
    public Chunk(Location location, String o) {
    ...
    public Chunk(Location location, String o, ArrayList<String> b) {
        this.x = location.getChunk().getX();
        this.z = location.getChunk().getZ();
        this.worldName = location.getWorld().getName();
        this.ownerName = o;
    ...
    public Chunk(int px, int pz, String w, String o, Date cd, String[] b) {
        this.x = px;
        this.z = pz;
        this.worldName = w;
        this.ownerName = o;
    ...
    public Chunk(int px, int pz, String w, String o, String[] b) {
        this.x = px;
        this.z = pz;
        this.worldName = w;
        this.ownerName = o;
    ...
    public Chunk(int px, int pz, String w, String o) {
        this.x = px;
        this.z = pz;
        this.worldName = w;
        this.ownerName = o;
    ...
    public Chunk(int px, int pz, String w) {
        this.x = px;
        this.z = pz;
        this.worldName = w;
    }
